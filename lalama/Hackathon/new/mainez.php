    ...
    <script type="text/javascript">
	 ...
	 var datum;
      function init() {
        ...
        var initExtent = new esri.geometry.Extent({"xmin":4073959.0882260324,"ymin":-152904.42845964813,"xmax":4125706.956375027,"ymax":-130508.37917212165,"spatialReference":{"wkid":102100}});
        ...
        var basemap = new esri.layers.ArcGISDynamicMapServiceLayer("http://esriea.cloudapp.net/ArcGIS/rest/services/arcgisonline/navteqDyn/MapServer");
...
function  getGeodata(params){
	 ...
	 httpc.send(params); 
	 httpc.onreadystatechange=function(jah){
